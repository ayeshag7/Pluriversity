        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-12 lg:py-8 lg:px-8">
            <div className="md:flex md:justify-between">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul className="text-white text-xs md:text-sm font-medium">
                            <li className="mb-4">
                                <a href="" rel="noreferrer" target="_blank" className="hover:underline ">Facebook</a>
                            </li>
                            <li className="mb-4">
                                <a href="https://discord.com/" rel="noreferrer" target="_blank" className="hover:underline">Twitter</a>
                            </li>
                            <li className="mb-4">
                                <a href="https://discord.com/" rel="noreferrer" target="_blank" className="hover:underline">Instagram</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                    <a href="" rel="noreferrer" target="_blank" className="text-white hover:text-[#89BE63]">
